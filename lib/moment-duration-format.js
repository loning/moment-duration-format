 ...
 *  https://github.com/chipersoft/moment-duration-format
 *
...
(function() {
	var hasModule, makeDuration,
	__slice = [].slice;

	hasModule = (typeof module !== "undefined" && module !== null) && (module.exports != null);

	makeDuration = function(moment) {
		...
		moment.duration.fn.format = function () {
			...
			tokens = _.map(tokens, function (token) {
				...
				if (token.isLeast && (settings.precision > 0)) {
					...
					val += "." + padZero(decVal[1] ? repeatZero(decVal[2]) + decVal[1] : "0", settings.precision, true).slice(0, settings.precision);
				}
	...
	if (hasModule) {
		module.exports = makeDuration(require("moment"));
	}

	if (typeof define === "function") {
		define("handlebars-duration", ["moment"], function(moment) {
			return makeDuration(moment);
		});
	}

	if (this.moment != null) {
		makeDuration(this.moment);
	}
